...
type NodeDescriptor struct {
	...
	AdminURL string                        `protobuf:"bytes,4,opt,name=admin_url,json=adminUrl" json:"admin_url"`
}
...
func (m *NodeDescriptor) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0x22
	i++
	i = encodeVarintMetadata(data, i, uint64(len(m.AdminURL)))
	i += copy(data[i:], m.AdminURL)
	return i, nil
}
...
func (m *NodeDescriptor) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AdminURL", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AdminURL = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipMetadata(data[iNdEx:])
...
var fileDescriptorMetadata = []byte{
	...
	,
}
